...
## やったことはないが興味があるもの
- webエンジニアとしてまだまだ未熟なのでどんどん吸収していきたい（ReactなどJavaScript全般、DjangoなどWebフレームワークの習得）
- データ基盤構築
...
#### コメント
これまでアプリケーションを開発した経験が少なく、自信がないのでチームで開発を進める体制を希望していました。しかし諸々の事情でほぼ一人で開発を進めることになり、ツラかったですがなんとかやり遂げました。
